  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>
        Enter the OTP code sent to verify your account
      </Text>
      {email && <Text style={styles.email}>{email}</Text>}

      <Text style={styles.otpLabel}>1 - 8 - 0 - 8</Text>
      <Text style={styles.otpSub}>Received Code</Text>
...
const styles = StyleSheet.create({
  ...
  otpLabel: { ...typography.h1, color: colors.text, fontWeight: '700', letterSpacing: 8, marginBottom: spacing.xs },
  otpSub: { ...typography.small, color: colors.subtext, marginBottom: spacing.xl },
  otpRow: {
    flexDirection: 'row',
    gap: spacing.sm,
